// Minimal static server for Halyard — no dependencies.
// Serves /app on http://localhost:8790. localhost is a secure context, so the
...
}).listen(PORT, () => console.log(`Halyard running →  http://localhost:${PORT}`));
